param(
  [string]$SourceDir = (Join-Path $PSScriptRoot 'OfficialDocumentFormatGB2312_0.01'),
  [string]$AddinName = 'OfficialDocumentFormatGB2312',
  [string]$Version = '0.01'
)
...
Write-Host "Restart WPS Writer, then look for the 公文格式·GB2312 tab."
